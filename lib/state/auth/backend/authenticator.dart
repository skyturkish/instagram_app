...
import 'package:instagram_app_sky/state/auth/constants/constants.dart';
...
class Authenticator {
  ...
  Future<AuthResult> loginWithFacebook() async {
    ...
    try {
      ...
      if (e.code == Constants.accountExistWithDifferentCredential && email != null && credential != null) {
