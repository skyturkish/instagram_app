...
/// See also [thumbnail].
class ThumbnailProvider extends AutoDisposeFutureProvider<ImageWithAspectRatio> {
  ThumbnailProvider({
    required this.request,
          ...
          debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product') ? null : $thumbnailHash,
        );
